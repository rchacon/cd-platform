...
# One client, reused across calls -- same connection-pool-reuse rationale
# as HttpApiClient in clients.py. Closed via aclose(), called from
# app.py's lifespan on shutdown.
...
# same algorithm, same test cases.
...
async def get_district(address: str) -> tuple[str, int]:
