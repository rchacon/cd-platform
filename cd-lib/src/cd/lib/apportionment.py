...
SEATS_PER_STATE: dict[str, int] = {
    ...
    # each with exactly one at-large seat. See NON_VOTING_TERRITORIES below
    # for which of these keys are non-voting.
    "AS": 1, "DC": 1, "GU": 1, "MP": 1, "PR": 1, "VI": 1,
}

# Jurisdictions whose single SEATS_PER_STATE seat is a non-voting
